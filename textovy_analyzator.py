...
if users.get(user) != password:
    ...
    if number.isalpha():
    ...
    elif int(number) not in range(4):
        ...
        print(f"There are {stat_2} titlecase words.")
        print(f"There are {stat_3} uppercase words.")
        print(f"There are {stat_4} lowercase words.")
        print(f"There are {stat_5} numeric string.")
        print(f"The sum of all the numbers {stat_6}.")
